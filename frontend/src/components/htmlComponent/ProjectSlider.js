            ...
            <div className="project-slider" style={{ width: '100%', height: '60vw', maxHeight: 700, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                ...
                >
                    <OptimizedImage
                        ...
                        priority={current === 0} // İlk resim kritik (above-the-fold)
                        style={{
                            width: '100%',
                            height: '100%',
                            objectFit: 'cover',
                    ...
                    {/* <button className="project-detail-button" 
                        onClick={() => 
                        navigate(`/project-detail/${encodeURIComponent(slides[current].project.name)}`)}>
                        Proje Detayları
                    </button> */}
                    <a  className="project-detail-button" href={`/project-detail/${encodeURIComponent(slides[current].project.name)}`} target="_blank" rel="noopener noreferrer">
                        Proje Detayları
                    </a>
                </div>
            </div>
